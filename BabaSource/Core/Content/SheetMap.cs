...
public static class SheetMap {
	...
	new Wobbler("teeth.3", new[] { new Point(1, 2), new Point(2, 2), new Point(3, 2) }, new Point(24, 24), sheets["teeth"]) }) },
			{ "text_zero", new Wobbler("text_0", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_zero"]) },
			...
			{ "text_seven", new Wobbler("text_7", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_seven"]) },
			{ "text_eight", new Wobbler("text_8", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_eight"]) },
			{ "text_nine", new Wobbler("text_9", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_nine"]) },
			...
			{ "text_big", new Wobbler("text_big", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_big"]) },
			...
			{ "text_lparen", new Wobbler("text_lparen", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_lparen"]) },
			...
			{ "text_percent", new Wobbler("text_percent", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_percent"]) },
			...
			{ "text_rparen", new Wobbler("text_rparen", new[] { new Point(0, 0), new Point(1, 0), new Point(0, 1) }, new Point(24, 24), sheets["text_rparen"]) },
